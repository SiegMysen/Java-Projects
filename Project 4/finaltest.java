public class finaltest {
    ...
    public static void main(String[] args) {
        ...
        String answers[] = {
                "str1: comp, len = 4",
                "str1: comp, len = 4  str2: comp, len = 4",
                "str1: 182, len = 3  str2: comp, len = 4",
                "str1: 182, len = 3  str2: , len = 0",
                "str1: 2182, len = 4  str2: , len = 0",
                ...
                "str1: , len = 0  str2: 12345$, len = 6",
                "str1: 12345$, len = 6  str2: 12345$, len = 6",
                "str1: 12345$12345$, len = 12  str2: 12345$, len = 6",
                ...
                "str1: orldlohelw, len = 10  str2: , len = 0",
                "str1: orldlohelw, len = 10  str2: ww, len = 2",
                "str1: orldlohelw, len = 10  str2: orldorldorld, len = 12",
                "str1: orldlohelw, len = 10  str2: helww, len = 5",
                "str1: orldlohelw, len = 10  str2: orldlohelwo, len = 11",
                "str1: q, len = 1  str2: q, len = 1",
                "str1: q, len = 1  str2: qq, len = 2",
                "str1: q, len = 1  str2: , len = 0",
                "str1: , len = 0  str2: q, len = 1",
                "str1: , len = 0  str2: , len = 0"
        };
        ...
        word1.removeWord(new Word("abcabc"));
        check(outStrInfo(word1), answers[checkCt++]);
        word1.removeWord(new Word("abcdd"));
        check(outStrInfo(word1), answers[checkCt++]);
        word1.removeWord(new Word("abcdefghabcc"));
        check(outStrInfo(word1), answers[checkCt++]);
        word1.removeWord(new Word("abc"));
        check(outStrInfo(word1), answers[checkCt++]);
        word1.removeWord(new Word("abc"));
        ...
        check(outStrInfo(word1), answers[checkCt++]);
        word1 = new Word("aaaabbbbaaaabbbb");
        word1.removeWord(new Word("aabb"));
        check(outStrInfo(word1), answers[checkCt++]);
        word1.removeWord(new Word("bbbbb"));
        check(outStrInfo(word1), answers[checkCt++]);
        word1.removeWord(new Word("aaab"));
        check(outStrInfo(word1), answers[checkCt++]);
        System.out.println();
        ...
        word1.flipWord(word2);
        check(outStrInfo(word1, word2), answers[checkCt++]);
        word2 = new Word("orldorldorld");
        word1.flipWord(word2);
        check(outStrInfo(word1, word2), answers[checkCt++]);
        word2 = new Word("helww");
        word1.flipWord(word2);
        check(outStrInfo(word1, word2), answers[checkCt++]);
        word2 = new Word("orldlohelwo");
        word1.flipWord(word2);
        check(outStrInfo(word1, word2), answers[checkCt++]);
        word1 = new Word("q");
        word2 = new Word("q");
